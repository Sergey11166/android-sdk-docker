...
RUN unzip /opt/${ANDROID_SDK_TOOLS_ZIP_FILE} -d ${ANDROID_HOME} && \
	...
	echo y | ${ANDROID_HOME}/tools/bin/sdkmanager "build-tools;28.0.3" "platforms;android-28" && \
	echo y | ${ANDROID_HOME}/tools/bin/sdkmanager "system-images;android-28;google_apis;x86_64" && \
	echo y | ${ANDROID_HOME}/tools/bin/sdkmanager "extras;android;m2repository" "extras;google;m2repository"
